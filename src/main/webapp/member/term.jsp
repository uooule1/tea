...
<body>
	...
	<main class = "main">
	<form name = "term" method = "post" action = "../member/regist.jsp">
		<table>
			<tr>
				<td>
					<input type = "checkbox" name = "check1" onclick="checkall()">이용약관, 개인정보 수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.
				</td>
			</tr>
			<tr>
				<td>
					<input type = "checkbox" name = "check2">이용약관 동의(필수)
				</td>
			</tr>
			<tr>
				<td>
					<textarea cols = "75" rows = "10" disabled style = "resize:none;">제1조(목적)
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
			...
			<tr>
				<td>
					<input type = "checkbox" name = "check3">개인정보 수집 및 이용 동의(필수)
				</td>
			</tr>
			<tr>
				<td>
					<textarea cols = "75" rows = "10" disabled style = "resize:none;" >1. 개인정보 수집목적 및 이용목적
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.</textarea>
			...
			<tr>
				<td>
					<input type = "checkbox" name = "check4" onclick="clear_check()">쇼핑정보 수신 동의(선택)
				</td>
			</tr>
			<tr>
				<td>
					<textarea cols = "75" rows = "10" disabled style = "resize:none;">할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 SMS와 이메일로 받아보실 수 있습니다.
...
선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.</textarea>
			...
			<tr>
				<td class = "right">
					<input type = "button" value = "확인" onclick = "check()" class = "small_button blue">
